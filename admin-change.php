...
<div class="wrapper _done">
	...
	<section class="content _content _done">
				...
				<div class="boss__column">
					<div class="boss__text">
						<div class="boss__text_setting">
							<a href="vendor/delete.php?id=<?php echo $idContents["id"]?>">Удалить</a>
							<a href="popup-change.php?id=<?php echo $idContents["id"]?>">Изменит</a>
						</div>
		...
		<a href="cons.php" class="con">
			<div class="con__title">Корзина</div>
		</div>
	</section>
	<!-----------------------------------  Content  --End--  ----------------------------------->
